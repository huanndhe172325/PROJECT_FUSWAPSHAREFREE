 ...
 * @author admin
 */
@WebServlet(name = "adminReportPost", urlPatterns = {"/adminReportPost"})
public class adminReportPost extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet adminReportPost</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet adminReportPost at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String requestJson = convertToStringArray(PostsReports).toString();

        request.setAttribute("monthOfRevenue", requestJson);
        request.setAttribute("listYear", listYear);
        request.getRequestDispatcher("HomePage/adminReportPost.jsp").forward(request, response);
    }
