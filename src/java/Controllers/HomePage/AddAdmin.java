...
public class AddAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String districtString=request.getParameter("district");
                      java.sql.Date date=java.sql.Date.valueOf("2024-5-5");

        
                DAOManageUser daomu = new DAOManageUser();
                daomu.addAdmin(mailString, userNameString, passString, phoneString, fullname,commune, districtString, date);
                response.sendRedirect("manageAdministrator");
    }
