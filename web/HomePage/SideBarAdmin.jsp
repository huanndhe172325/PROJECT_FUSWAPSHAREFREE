...
<div class="d-flex">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white"  style="height: 100vh; width: 250px; background-color: #8c8377">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            <li >
                <a href="adminHome" class="nav-link d-flex align-items-center" >
            ...
            <li>
                <a href="manageUsers" class="nav-link sidebarBtn" style="">
                    <i class="fa-brands fa-product-hunt pe-3" style="margin-right: 10px"></i>
                    Movies
                </a>
            </li>
            <li>
                <a href="HomePage/manageUsers.jsp" class="nav-link sidebarBtn" >
