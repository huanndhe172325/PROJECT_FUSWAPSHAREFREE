...
<!-- Mirrored from friendkit.cssninja.io/dashboard-posts.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 May 2024 06:39:27 GMT -->
...
<head>
    ...
    <title>Friendkit | My Posts</title>
...
<body>
    ...
    <div class="dashboard-aside">
        ...
        <div class="dashboard-aside-body">
            ...
            <a href="manageUser" class="dashboard-aside-link">
                <div>
    ...
    <div class="view-wrapper is-dashboard">
        ...
        <div id="creator-dashboard" class="dashboard-container">
            ...
            <div class="dashboard-toolbar">
                <h1 class="title is-4">My Posts</h1>
                <div class="actions">
